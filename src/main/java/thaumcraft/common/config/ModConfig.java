...
public class ModConfig
{
    ...
    public static void postInitLoot() {
        ...
        for (final PotionType pt : PotionType.REGISTRY) {
            ThaumcraftApi.addLootBagItem(PotionUtils.addPotionToItemStack(new ItemStack((Item)Items.POTIONITEM), pt), 2, 0, 1, 2);
            ThaumcraftApi.addLootBagItem(PotionUtils.addPotionToItemStack(new ItemStack((Item)Items.SPLASH_POTION), pt), 2, 0, 1, 2);
            ThaumcraftApi.addLootBagItem(PotionUtils.addPotionToItemStack(new ItemStack((Item)Items.LINGERING_POTION), pt), 2, 1, 2);
        }
    ...
    public static class CONFIG_MISC
    {
        ...
        @Config.Comment({ "How many milliseconds passes after a shield has been damaged before it can start recharging again. Minimum of 0.", "A shield being reduced to 0 will take double this time before beginning to recharge again."})
        ...
        static {
            ...
            CONFIG_MISC.shieldRecharge = 500;
            CONFIG_MISC.shieldWait = 5000;
